                ...
                .then(res => {
                    ...
                    post('https://www.y2mate.com/mates/en60/convert', {
                        ...
                        .then(res => {
                            ...
                            resolve({url: /<a.+?href="(.+?)"/.exec(res.result)[1], thumb: thumb, titulo: title, filesizeF: filesize, filesize: KB, canal: 'off', publicado: 'off', visu: 'off'
                            })
                        }).catch(reject)
                }).catch(reject)
            ...
            post('https://www.y2mate.com/mates/en60/analyze/ajax', {
                ...
                .then(res => {
                    ...
                    post('https://www.y2mate.com/mates/en60/convert', {
                        ...
                        .then(res => {
                            let KB = parseFloat(filesize) * (1000 * /MB$/.test(filesize))
                            resolve({url: /<a.+?href="(.+?)"/.exec(res.result)[1], thumb: thumb, titulo: title, filesizeF: filesize, filesize: KB, visu: 'off', publicado: 'off'
                            })
                        }).catch(reject)
                }).catch(reject)
        } else reject('URL INVALID')
