...
async function hentaihome(nome) {
  return new Promise((resolve, reject) => {
    axios.get(`https://www.hentaihome.net/?s=${nome}`).then( ({data}) => {
      ...
      resolve({status: 200, autor: 'VNCS CODE - 73999197974', resultado: postagem})
    })
    .catch(e => {
...
async function lojadomecanico(nome) {
  return new Promise((resolve, reject) => {
    axios.get(`https://busca.lojadomecanico.com.br/busca?q=${nome}`).then( ({data}) => {
      ...
      resolve({status: 200, autor: 'VNCS CODE - 73999197974', resultado: dados})
    })
    .catch(e => {
      reject({status: 500, msg: `Erro no módulo`})
    });
...
//mediafireDl("https://www.mediafire.com/file/aus4a01ncf35q6e/AKAME-BOT4.0.zip/file?dkey=ituyq2gnvc0&r=1137").then(console.log)
...
async function randomGrupos(categoria) {
  return new Promise( (resolve, reject) => {
    ...
    .then( async ({data}) => {
      ...
      resolve({status: 200, criador: 'VNCS CODE - 73999197974', resultado: dados2})
    })
    .catch(e => {
      reject(e)
    })
...
async function topFlix(query) {
  return new Promise((resolve, reject) => {
    ...
    .then( ({data}) => {
      ...
      resolve({status: 200, criador: 'VNCS CODE - 73999197974', resultado: dados})
    })
    .catch(e => {
      reject(e)
    });
...
async function ultimasNoticias() {
 return new Promise((resolve, reject) => {
   ...
   resolve({status: 200, autor: 'VNCS CODE - 73999197974', resultado: dados2})
  })
   .catch(e => {
     reject(e)
   })
...
async function xvideosSearch(q) {
  return new Promise((resolve, reject) => {
    ...
    .then((res) => {
      ...
      resolve({status: res.status, criador: 'VNCS CODE - 73999197974', resultado: dados})
    })
    .catch(e => {
      reject(e)
    });
...
async function mercadoLivreSearch2(q) {
  return new Promise((resolve, reject) => {
...
//xvideosDownloader("https://www.xvideos.com/video65213511/essa_gostosa_ia_servir_apenas_de_cameraman_para_gravar_eu_comendo_a_amiga_dela_so_que_nao_resisti_o_rabao_e_acabei_chupando_ela_e_fiz_ela_gozar_tres_vezes_no_meu_pau").then(console.log)
...
//hentaiimg('pokemon').then(console.log)
...
animesBrSearchEps('https://animesbr.biz/anime/darling-in-the-franxx/').then(console.log).catch(console.log)
*/
async function ultimasNoticias() {
  return new Promise(async(resolve, reject) => {
    const dados1 = [];
...
async function iFunny() {
  return new Promise((resolve, reject) => {
    ...
    .then(res => {
      ...
      resolve({status: res.status, autor: 'VNCS CODE - 73999197974', imagens: dados, videos: dados2})
    })
    .catch(e => {
      reject(e)
    });
...
async function amazonSearch(query) {
  return new Promise((resolve, reject) => {
    ...
    .then((res) => {
      ...
      resolve({status: res.status, autor: 'VNCS CODE - 73999197974', resultado: dados})
    })
    .catch(e => {
      reject(e)
    });
...
// playStoreSearch('Animes brasil').then(console.log).catch(console.log)
...
//pensadorSearch("amor Incorrespondido").then(console.log)
//letrasMusica("https://m.letras.mus.br/pineapple/poesia-acustica-13/").then(console.log)